...
public class DemoActivity extends Activity {
    ...
    private void initViews() {
        ...
        mEditSpinner2.setDropDownDrawable(getResources().getDrawable(R.drawable.ic_tick_round), 100, 100);
        mEditSpinner2.setDropDownDrawableSpacing(20);
        mEditSpinner2.setEditable(false);
        mEditSpinner2.setAdapter(new ArrayAdapter<String>(this, R.layout.mam_lay, stringArray2));
        mEditSpinner2.setDropDownBackgroundDrawable(getResources().getDrawable(R.drawable.custom_editor_bkg_normal));
